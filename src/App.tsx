    ...
    <div className="page">
      <header className="page__head">
        ...
        <p className="page__intro">
          Solid lines move an article forwards; dashed lines take it backwards — a send-back, an
          undo, or a pull out of live. Line colour shows who performs the transition, and badges mark which states sit in an open claim
